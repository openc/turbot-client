require "spec_helper"
require "turbot/command/releases"

describe Turbot::Command::Releases do
  ...
  describe "releases" do
    ...
    it "should list releases" do
      Turbot::Command::Releases.any_instance.should_receive(:time_ago).exactly(5).times.and_return('2012/09/10 11:36:44 (~ 0s ago)', '2012/09/10 11:36:43 (~ 1s ago)', '2012/09/10 11:35:44 (~ 1m ago)', '2012/09/10 10:36:44 (~ 1h ago)', '2012/01/02 12:34:56')
...
STDOUT
    ...
    it "should list a specified number of releases" do
      Turbot::Command::Releases.any_instance.should_receive(:time_ago).exactly(3).times.and_return('2012/09/10 11:36:44 (~ 0s ago)', '2012/09/10 11:36:43 (~ 1s ago)', '2012/09/10 11:35:44 (~ 1m ago)')
...
STDOUT
 ...
 !    Usage: turbot releases:info RELEASE
STDERR
      stdout.should == ""
    end

    it "shows info for a single release" do
      Turbot::Command::Releases.any_instance.should_receive(:time_ago).and_return("2012/09/11 12:34:56 (~ 0s ago)")
