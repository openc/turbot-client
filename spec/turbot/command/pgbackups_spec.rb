require "spec_helper"
require "turbot/command/pgbackups"
...
STDERR
  ...
  describe Pgbackups do
    before do
      ...
      @pgbackups.turbot.stub!(:info).and_return({})
      ...
      api.put_config_vars(
        "example",
        {
          ...
          "PGBACKUPS_URL"           => "https://ip:password@pgbackups.turbot.com/client"
        }
      )
...
STDOUT
      ...
      it "destroys no backup without a name" do
        ...
        stderr.should == <<-STDERR
 !    Usage: turbot pgbackups:destroy BACKUP_ID
...
STDOUT
      ...
      context "on errors" do
        def stub_failed_capture(log)
          ...
          any_instance_of(Turbot::Command::Pgbackups) do |pgbackups|
