...
[ ] sumo-rankings  Turbot Sumo ranks and visualizes the scale of your app, and suggests the optimum combination of dynos and add-ons to take it to the next level.
...
STDOUT
 ...
 !    Usage: turbot labs:info FEATURE
...
For more information see: http://devcenter.turbot.com/articles/labs-user-env-compile
STDOUT
    end
    ...
    it "shows usage if no feature name is specified for enable" do
      ...
      stderr.should == <<-STDERR
 !    Usage: turbot labs:enable FEATURE
...
STDOUT
    ...
    it "shows usage if no feature name is specified for disable" do
      ...
      stderr.should == <<-STDERR
 !    Usage: turbot labs:disable FEATURE
