...
describe Turbot::Client, "ssl endpoints" do
  ...
  it "adds an ssl endpoint" do
    stub_request(:post, "https://api.turbot.com/apps/example/ssl-endpoints").
  ...
  it "gets info on an ssl endpoint" do
    stub_request(:get, "https://api.turbot.com/apps/example/ssl-endpoints/tokyo-1050").
      to_return(:body => %{ {"cname": "tokyo-1050" } })
    @client.ssl_endpoint_info("example", "tokyo-1050").should == { "cname" => "tokyo-1050" }
  end

  it "lists ssl endpoints for an app" do
    stub_request(:get, "https://api.turbot.com/apps/example/ssl-endpoints").
  ...
  it "removes an ssl endpoint" do
    stub_request(:delete, "https://api.turbot.com/apps/example/ssl-endpoints/tokyo-1050")
    @client.ssl_endpoint_remove("example", "tokyo-1050")
  end

  it "rolls back an ssl endpoint" do
    stub_request(:post, "https://api.turbot.com/apps/example/ssl-endpoints/tokyo-1050/rollback").
      to_return(:body => %{ {"cname": "tokyo-1050" } })
    @client.ssl_endpoint_rollback("example", "tokyo-1050").should == { "cname" => "tokyo-1050" }
  end

  it "updates an ssl endpoint" do
    stub_request(:put, "https://api.turbot.com/apps/example/ssl-endpoints/tokyo-1050").
      with(:body => { :accept => "json", :pem => "pem content", :key => "key content" }).
      to_return(:body => %{ {"cname": "tokyo-1050" } })
