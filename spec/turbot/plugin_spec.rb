  ...
  describe Plugin do
    ...
    describe "management" do
      ...
      it "installs pulling from the plugin url" do
        ...
        File.directory?("#{@sandbox}/turbot_plugin").should eq(true)
...
STDERR
      ...
      it "adds the lib folder in the plugin to the load path, if present" do
        ...
        Plugin.load!
        lambda { require 'my_custom_plugin_file' }.should_not raise_error
      end
