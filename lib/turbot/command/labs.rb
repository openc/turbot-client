...
#
class Turbot::Command::Labs < Turbot::Command::Base
  ...
  #Example:
  #
  # === User Features (david@turbot.com)
  # [+] dashboard  Use Turbot Dashboard by default
  #
  # === App Features (glacial-retreat-5913)
  # [ ] preboot            Provide seamless web dyno deploys
  # [ ] user-env-compile   Add user config vars to the environment during slug compilation  # $ turbot labs -a example
  #
  def index
    validate_arguments!
    ...
    styled_header "User Features (#{Turbot::Auth.user})"
...
private
  ...
  def app
    super
  rescue Turbot::Command::CommandFailed
    nil
  end
