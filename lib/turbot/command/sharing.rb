...
module Turbot::Command
  ...
  class Sharing < Base
    ...
    #Example:
    #
    # $ turbot sharing:transfer collaborator@example.com
    # Transferring example to collaborator@example.com... done
    #
    # $ turbot sharing:transfer acme-widgets
    ...
    def transfer
      unless target = shift_argument
        error("Usage: turbot sharing:transfer EMAIL\nMust specify EMAIL to transfer an app.")
      end
      validate_arguments!
      org_from_app!
