...
# manage app releases
#
class Turbot::Command::Releases < Turbot::Command::Base
  ...
  def info
    unless release = shift_argument
      error("Usage: turbot releases:info RELEASE")
    end
    validate_arguments!
  ...
  #Example:
  #
  # $ turbot releases:rollback
  # Rolling back example... done, v122
  #
  # $ turbot releases:rollback v42
